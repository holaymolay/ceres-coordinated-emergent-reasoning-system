...
- SEA runs before Objective Contracts/Specs/Gap Ledgers/Planning and outputs only `elicitation.md`.
- Prompt Debugger gates all intake before governance.
- Governed lifecycle: Objective Contract -> Inference (Gap Ledger) -> Planning (Task Plan -> `todo.md`) -> Controlled Prototyping -> Lock-In -> Execution -> Verification.
