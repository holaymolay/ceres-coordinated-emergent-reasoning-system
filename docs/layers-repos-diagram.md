...
- Interface / Intake / Inference / Planning / Governance (0–4):
  ...
  - hub (ceres-coordinated-emergent-reasoning-system) for PROMPTLOADER, Constitution, schemas, prompt-debugger, todo templates
- Execution (5):
...
- Persistence/Memory (8):
  - run receipts (`runs/`), `completed.md`, Gap Ledger, `handover.md`; hub standards apply
