...
**Hub entry:** Load CERES via the umbrella `PROMPTLOADER.md` + `CONSTITUTION.md` and use hub todo templates (`scripts/init-todo-files.sh`) when bootstrapping a project. This component is a directory in the CERES monorepo.
